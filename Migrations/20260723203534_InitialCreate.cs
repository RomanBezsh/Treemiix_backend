    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:order_status", "pending,processing,shipped,delivered,cancelled,refunded")
                .Annotation("Npgsql:Enum:product_status", "active,inactive,archived,deleted")
                .Annotation("Npgsql:Enum:seller_status", "active,inactive,suspended,pending_verification");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedActivationsCount = table.Column<int>(type: "integer", nullable: false),
                    LimitPerUser = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GiftCards_Users_ActivatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldCost = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoryPriceProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoryPriceProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductAvatarUrl = table.Column<string>(type: "text", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    NameAttr = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionVotes_ProductQuestions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "ProductQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductGalleryId = table.Column<Guid>(type: "uuid", nullable: true),
                    ProductVideoId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductReviews_ProductGalleries_ProductGalleryId",
                        column: x => x.ProductGalleryId,
                        principalTable: "ProductGalleries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ProductReviews_ProductVideos_ProductVideoId",
                        column: x => x.ProductVideoId,
                        principalTable: "ProductVideos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GiftCards_ActivatedByUserId",
                table: "GiftCards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoryPriceProducts_ProductId",
                table: "HistoryPriceProducts",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviews_ProductGalleryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviews_ProductVideoId",
                table: "ProductReviews",
                column: "ProductVideoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromoCodeProducts_PromoCodeId",
                table: "PromoCodeProducts",
                column: "PromoCodeId");
